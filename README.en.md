...
> **Status:** running and in use. 449 automated checks, 107 of them in a real browser. What is still
...
**449 checks in seven suites**, each one setting up its own preconditions:
