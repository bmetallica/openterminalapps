...
export const EN: Record<string, string> = {
  ...
  'Art des Verzeichnisses': 'Kind of directory',
  'Basis der Konten': 'Base of the accounts',
  'Dienstkonto': 'Service account',
  'Kennwort des Dienstkontos': 'Service account password',
  'Eingeschaltet': 'Enabled',
  'Konten aus dem Verzeichnis zulassen': 'Allow accounts from the directory',
  ...
  'Gespeichert.': 'Saved.',
  'Entfernt.': 'Removed.',
  'Abgleich gelaufen.': 'Sync finished.',
  'Hat nicht geklappt': 'That did not work',
  '{n} Konten geholt.': 'Fetched {n} accounts.',
  ...
  'Anmeldename ist uid, Kennung entryUUID.': 'Login name is uid, identifier entryUUID.',
  'Wo die Personen liegen, nicht die Wurzel der Domäne.': 'Where the people are, not the root of the domain.',
  'Ein Konto, das lesen darf. Mehr braucht es nicht.': 'An account that may read. Nothing more is needed.',
  'Ein Kennwort ist hinterlegt. Leer lassen heisst: unverändert.':
    'A password is stored. Leaving it empty means: unchanged.',
  'Wird gebraucht, um die Anbindung anzulegen.': 'Needed to create the binding.',
  'Aus heisst: Die Anbindung bleibt stehen, aber niemand meldet sich darüber an.':
  ...
  // Netz — Firewall, Profile, Übersicht
  'Netz': 'Network',
  'Jeder Arbeitsplatz hängt in einem eigenen Netz und erreicht die Aussenwelt nur über den Router. Ohne Freigabe gilt: kein Firmennetz, keine Nachbarsitzung, kein Wirt.': 'Every workspace sits in its own network and reaches the outside world only through the router. Without an exception: no corporate network, no neighbouring session, no host.',
  'Wer läuft gerade wo': 'Who is running where',
  'Zurzeit läuft kein Arbeitsplatz.': 'No workspace is running right now.',
  'Verkehr': 'Traffic',
  'Abgewiesen': 'Rejected',
  'Freigaben nach aussen': 'Inbound exceptions',
  '+ NAT': '+ NAT',
  'Port von {user} nach aussen freigeben': 'Publish a port of {user}',
  'Port im Arbeitsplatz': 'Port inside the workspace',
  'Der Port, auf dem die eigene Anwendung im Arbeitsplatz lauscht.': 'The port the person\u2019s own application listens on inside the workspace.',
  'Für wie viele Tage': 'For how many days',
  '0 heisst unbefristet. Der Ablauf wird durchgesetzt, nicht nur angezeigt.': '0 means no expiry. The expiry is enforced, not just displayed.',
  'Wofür': 'What for',
  'Pflicht. Ohne Notiz traut sich später niemand, die Freigabe wieder zu entfernen.': 'Required. Without a note, nobody will dare remove the exception later.',
  'Freigeben': 'Publish',
  'Freigabe angelegt': 'Exception created',
  'Freigabe entfernt': 'Exception removed',
  'abgelaufen': 'expired',
  'bis {datum}': 'until {datum}',
  'Freigaben für alle Arbeitsplätze': 'Exceptions for all workspaces',
  'Der Dateiserver, das interne Rechenzentrum, der Paketspiegel — was jeder erreichen soll, steht hier und nicht in jedem Profil.': 'The file server, the internal data centre, the package mirror \u2014 what everyone should reach belongs here, not in every profile.',
  'Globale Freigaben gesetzt': 'Global exceptions saved',
  'Netzprofile': 'Network profiles',
  ...
  'Keine Freigaben — es gilt allein die Stufe.': 'No exceptions \u2014 the level alone applies.',
  'Freigabe hinzufügen': 'Add exception',
  '192.168.66.10, 10.20.0.0/16 oder git.firma.de': '192.168.66.10, 10.20.0.0/16 or git.company.com',
  'Wofür? (Pflicht)': 'What for? (required)',
  'Ziel': 'Target',
  'Ports': 'Ports',
  'beide': 'both',
  'Weg': 'Remove',
  'Stufe': 'Level',
  'Abgeschottet': 'Isolated',
  'Internet': 'Internet',
  'Aus': 'Off',
  'Nur was OTA selbst braucht. Kein Internet, kein Firmennetz.': 'Only what OTA itself needs. No internet, no corporate network.',
  'Internet ja, Firmennetz nein. Die Vorgabe.': 'Internet yes, corporate network no. The default.',
  'Der Router lässt alles durch. Verlangt eine Begründung.': 'The router lets everything through. Requires a justification.',
  'Begründung': 'Justification',
  'Warum braucht dieser Arbeitsplatz keine Einschränkung? Steht im Protokoll.': 'Why does this workspace need no restriction? It goes into the audit log.',
  '{n} Freigaben': '{n} exceptions',
  '{n} Arbeitsplätze': '{n} workspaces',
  'nicht zugewiesen': 'not assigned',
  'Gilt noch für Arbeitsplätze.': 'Still in use by workspaces.',
  'Was dieser Arbeitsplatz im Netz erreichen darf. Ohne Profil gilt die Vorgabe: Internet ja, Firmennetz nein, Nachbarsitzung nein.': 'What this workspace may reach on the network. Without a profile the default applies: internet yes, corporate network no, neighbouring session no.',
  'Netzprofil': 'Network profile',
  'Vorgabe (Internet, kein Firmennetz)': 'Default (internet, no corporate network)',
  'Fehlgeschlagen': 'Failed',
  'Diese Sitzung läuft nicht mehr.': 'That session is no longer running.',

  'abgeschottet': 'isolated',
  'ohne Einschränkung': 'unrestricted',
  'Internet, kein Firmennetz': 'internet, no corporate network',

  'Portfreigaben über den Wirt': 'Published ports via the host',
  'Eine Freigabe gilt für einen Menschen an einem Arbeitsplatz — nicht für eine Sitzung. Sie bleibt bestehen, wenn er Feierabend macht, und greift beim nächsten Start wieder auf die dann gültige Adresse.': 'An exception belongs to a person and a workspace \u2014 not to a session. It survives the end of the day and applies again at the next start, to whatever address is then in force.',
  'Aussen': 'Outside',
  'Innen': 'Inside',
  'Bis': 'Until',
  'Zustand': 'State',
  ...
  'greift': 'in force',
  'wartet auf Start': 'waiting for start',
  'Neue Freigabe': 'New exception',
  ...
  // Nachgetragen 2026-09-05: die Klartext-Namen der Protokollvorgaenge
  // (Monitor.tsx, ACTION_TEXT). Sie standen bis dahin nur auf Deutsch da.
  'Anmeldung über die zentrale Anmeldung': 'Signed in via central sign-in',
  'Zentrale Anmeldung abgewiesen': 'Central sign-in refused',
  'Zentrale Anmeldung zurückgewiesen': 'Central sign-in rejected',
  'Rückfallcode benutzt': 'Recovery code used',
  'Rückfallcode falsch': 'Recovery code wrong',
  'Verzeichnis nicht erreichbar': 'Directory unreachable',
  'Abmeldung über den Rückkanal': 'Sign-out via back-channel',
  'Zweiter Faktor eingerichtet': 'Second factor set up',
  'Zweiter Faktor abgeschaltet': 'Second factor switched off',
  'Zweiter Faktor zurückgesetzt': 'Second factor reset',
  'Auf fremden Bildschirm geschaltet': 'Attached to someone else’s screen',
  'Einmal-Skript angelegt': 'One-off script created',
  'Einmal-Skript gelöscht': 'One-off script deleted',
  'Einmal-Skript zurückgesetzt': 'One-off script reset',
  'Nutzer aus dem Verzeichnis übernommen': 'User adopted from the directory',
  'Bestandskonten übernommen': 'Existing accounts adopted',
  'Übernahme zurückgenommen': 'Adoption undone',
  'Anmeldung eingerichtet': 'Sign-in configured',
  'Mit Keycloak abgeglichen': 'Synchronised with Keycloak',
  'Verzeichnis in Keycloak eingerichtet': 'Directory attached in Keycloak',
  'Verzeichnis in Keycloak entfernt': 'Directory removed from Keycloak',
  'Verzeichnis abgeglichen': 'Directory synchronised',
  'Notfallkonto gesetzt': 'Emergency account set',
  'Notfallkonto entfernt': 'Emergency account removed',
  'Anwendung angebunden': 'Application attached',
  'Angebundene Anwendung geändert': 'Attached application changed',
  'Angebundene Anwendung entfernt': 'Attached application removed',
  'Geheimnis der Anwendung erneuert': 'Application secret rotated',
  'Netzprofil angelegt': 'Network profile created',
  'Netzprofil gelöscht': 'Network profile deleted',
  'Netzprofil auf „aus“ gesetzt': 'Network profile set to “off”',
  'Globale Freigaben geändert': 'Global exceptions changed',
  'Portfreigabe angelegt': 'Published port created',
  'Portfreigabe entfernt': 'Published port removed',
  'Image-Bau gestartet': 'Image build started',
  'Image-Fassung aktiviert': 'Image version activated',
  'Image-Fassung gelöscht': 'Image version deleted',
  'Session eingefroren': 'Session frozen',
  'Rezept angelegt': 'Recipe created',
  'Rezept geändert': 'Recipe changed',
  'Rezept gelöscht': 'Recipe deleted',
  'Registry eingetragen': 'Registry added',
  'Registry aktualisiert': 'Registry refreshed',
  'Aus Registry übernommen': 'Imported from registry',
  'Datei in die eigene Ablage gelegt': 'File added to own store',
  'Datei aus der eigenen Ablage gelöscht': 'File deleted from own store',
  'Datei in die gemeinsame Ablage gelegt': 'File added to the shared store',
  'Datei aus der gemeinsamen Ablage gelöscht': 'File deleted from the shared store',
  'Ordner in der gemeinsamen Ablage angelegt': 'Folder created in the shared store',
  'Datei ins Gruppenlaufwerk gelegt': 'File added to the group drive',
  'Datei aus dem Gruppenlaufwerk gelöscht': 'File deleted from the group drive',
  'Skeleton-Datei hinzugefügt': 'Skeleton file added',
  'Skeleton-Datei entfernt': 'Skeleton file removed',
  'Skeleton-Ordner angelegt': 'Skeleton folder created',
  'Einstellungen geändert': 'Settings changed',
  'Marke geändert': 'Brand changed',
  'Zeichen gesetzt': 'Logo set',
  'Sicherung gestartet': 'Backup started',
  'Sicherungsplan geändert': 'Backup schedule changed',
